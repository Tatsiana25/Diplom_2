public class UserData {
    public static final String BASE_URL = "https://stellarburgers.nomoreparties.site/api/auth/login";
    public static final String REGISTERED_URL = "https://stellarburgers.nomoreparties.site/api/auth/register";
    ...
    public static final String EXISTING_USER_NAME = "Tanaka";

    public static final String CHANGE_USER_EMAIL = "change@test.com";
    public static final String CHANGE_USER_PASSWORD = "password123";
}
